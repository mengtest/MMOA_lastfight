...
namespace BlGame.GameEntity
{
    ...
    public class Ientity
    {
		...
		/// <summary>
		/// 主要是Iselfplayer用，测试摇杆移动（无服务器）
		/// </summary>
		public virtual void OnExecuteLocalMove(){}
...
//				sThisSyncDir.z +=45;
		...
		//工具函数
		private Vector3 ConvertVector3ToDir(Vector3 vec)
		{
			//Math.Atan2 方位角
			//相当于夹角
			//目前游戏，例如x=-1,z=7，所以夹角一般是45度
			Vector3 dir = new Vector3 (vec.x, (float)Math.Atan2 (vec.z, vec.x), vec.z);
