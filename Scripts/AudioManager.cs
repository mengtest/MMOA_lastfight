...
namespace BlGame
{
    public class AudioManager
    {
        ...
        {
			GameObject blGameGameObj = null;
			if (JxBlGame.Instance == null) {
				blGameGameObj = GameObject.Find ("JxBlGame");
			} else {
				blGameGameObj = JxBlGame.Instance.gameObject;
			}
            ...
            {
				AudioSource ad = blGameGameObj.AddComponent<AudioSource>();
			...
			HeroMoveAudio = blGameGameObj.AddComponent<AudioSource>();
            HeroMoveAudio.volume = Settings.AudioVolume;
            HeroMoveAudio.loop = true;
            HeroMoveAudio.playOnAwake = false;

			LoopAudioSource = blGameGameObj.AddComponent<AudioSource>();
            LoopAudioSource.loop = true;
            LoopAudioSource.playOnAwake = false;
            LoopAudioSource.volume = Settings.AudioVolume;

			GameKillAudioSource = blGameGameObj.AddComponent<AudioSource>();
            GameKillAudioSource.volume = Settings.AudioVolume;

			HeroGetMoneySource = blGameGameObj.AddComponent<AudioSource>();
            HeroGetMoneySource.volume = Settings.AudioVolume;


			GuideVoice = blGameGameObj.AddComponent<AudioSource>();
